...
const sellerAddress ='0x1F80c833D0580910E2e3ecE17835CBA45253112a';
const privateKey='0x56b090c5dfbbf1365dd10e754f4d785b5440212ead293be85641696cbd2df6fb';
   ...
   toEth: async(bala)=> {
    ...
    performTransaction: async (buyerAddress,total) => {
        try {
            ...
            console.log("buyer address",buyerAddress ,"price : ",totalPriceInWei,"balance :",totalPriceInWei);
