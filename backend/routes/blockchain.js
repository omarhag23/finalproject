...
const sellerAddress ='0xaF4220B85f07caA01d99b41bf8e7e6685eA42def';
...
const Blockchain = {
	...
	depositTransaction: async (buyerAddress,total) => {
        ...
        const tx1 = {
            ...
            gasPrice: gasPrice,
            data: encodedABI,
            value: 2 // This is for transferring any additional value, but your function doesn't accept ether, so set it to 0
        };
